...
export default function WorkPage() {
    return(
        <div className="flex flex-col items-center p-6 min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            <div className="flex flex-col items-start p-6 sm:px-6 w-full max-w-6xl mx-auto">
                <motion.h1
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.6 }}
                    className="text-xl sm:text-2xl font-light italic mb-2"
                >
                    Work
                </motion.h1>
                ...
                <motion.h2
                    ...
                    className="text-3xl sm:text-4xl mb-6 font-extrabold text-gray-600"
                >
                    Recent Projects
                </motion.h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl mx-auto">
                {projects.map((project, index) => (
                    <motion.div
                        ...
                        className="max-w-md p-6 border border-gray-100 rounded-2xl shadow-md hover:shadow-xl hover:scale-[1.03] hover:bg-gradient-to-r hover:from-blue-50 hover:to-white transition-transform duration-300 bg-white"
                    >
